...
import { Eye, EyeOff, Mail, Lock, User, Crown, Gift } from 'lucide-react';
...
const RegisterModal = ({ isOpen, onClose, onSwitchToLogin }) => {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="sm:max-w-md bg-gray-900 border-purple-500/30 text-white max-h-[90vh] overflow-y-auto">
        <DialogHeader className="text-center">
          <div className="flex justify-center mb-4">
            <div className="p-3 bg-gradient-to-r from-yellow-600 to-yellow-500 rounded-full">
        ...
        {/* Bonus Banner */}
        <div className="bg-gradient-to-r from-yellow-600/20 to-yellow-500/20 border border-yellow-400/30 rounded-lg p-3 mb-4 text-center">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                className="pl-10 bg-gray-800 border-purple-500/30 text-white placeholder:text-gray-500 focus:border-yellow-400"
              />
            </div>
          </div>
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <Input
                ...
                required
                minLength={8}
                className="pl-10 pr-10 bg-gray-800 border-purple-500/30 text-white placeholder:text-gray-500 focus:border-yellow-400"
              />
              <button
                type="button"
          ...
          <div className="flex items-start space-x-2">
            ...
            <Label htmlFor="terms" className="text-sm text-gray-300 leading-5">
              ...
              <a href="#" className="text-yellow-400 hover:underline">Política de Privacidade</a> e{' '}
              <a href="#" className="text-yellow-400 hover:underline">Jogo Responsável</a>
            </Label>
          </div>
